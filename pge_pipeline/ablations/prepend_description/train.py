"""train.py — PGE train phase, benchmark-description ablation.

FiLM joint-EM on pooled benchmarks, with optional benchmark description prepending
controlled by INCLUDE_BENCHMARK_DESCRIPTION.
"""
