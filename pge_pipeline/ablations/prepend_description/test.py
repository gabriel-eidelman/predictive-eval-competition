"""test.py — PGE test phase, benchmark-description ablation.

Loads a checkpoint from train.py, rebuilds the pooled benchmark data
deterministically, embeds the held-out eval items (respecting
include_benchmark_description from the manifest), and runs stage 3.
"""
